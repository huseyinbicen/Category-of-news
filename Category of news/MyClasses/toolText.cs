...
namespace Category_of_news.MyClasses
{
    class toolText
    {
        ...
        {
            String ss = "";
            String[] abc = Regex.Split(text, @"[^a-zA-Z0-9]");
        ...
        private int[] PieceOfNumbers(Byte[] Piece)
        {
            int[] matris = new int[256];
